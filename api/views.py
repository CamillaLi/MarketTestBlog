...
@api.route("/index/toparticle/")
def get_top_article_index():
    """获取所有文章索引信息
    """
    #print IndexData.get_top_article()
    return jsonify(IndexData.get_top_article())

@api.route("/index/article/")
def get_all_article_index():
    """获取所有文章索引信息
    """
    #print IndexData.get_index_data().get("article_index")
